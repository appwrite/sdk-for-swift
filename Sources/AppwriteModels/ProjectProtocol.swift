...
open class ProjectProtocol: Codable {
    ...
    /// Protocol ID.
    public let id: AppwriteEnums.ProjectProtocolId
    /// Protocol status.
    public let enabled: Bool

    init(
        id: AppwriteEnums.ProjectProtocolId,
        enabled: Bool
    ) {
        self.id = id
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.id = AppwriteEnums.ProjectProtocolId(rawValue: try container.decode(String.self, forKey: .id))!
