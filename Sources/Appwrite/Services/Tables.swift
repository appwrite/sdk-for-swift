...
open class Tables: Service {
    ...
    open func list(
        ...
        let apiPath: String = "/databases/{databaseId}/tables"
    ...
    open func get(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
    ...
    open func listColumns(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func createBooleanColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/boolean"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func updateBooleanColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/boolean/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func createDatetimeColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/datetime"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func updateDatetimeColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/datetime/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func createEmailColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/email"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func updateEmailColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/email/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func createEnumColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/enum"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func updateEnumColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/enum/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func createFloatColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/float"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func updateFloatColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/float/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func createIntegerColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/integer"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func updateIntegerColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/integer/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func createIpColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/ip"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func updateIpColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/ip/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func createRelationshipColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/relationship"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func createStringColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/string"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func updateStringColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/string/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func createUrlColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/url"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func updateUrlColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/url/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func getColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func updateRelationshipColumn(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/columns/{key}/relationship"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func listIndexes(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/indexes"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
    ...
    open func getIndex(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/indexes/{key}"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{key}", with: key)
    ...
    open func decrementRowColumn<T>(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/decrement"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{rowId}", with: rowId)
    ...
    open func incrementRowColumn<T>(
        ...
        let apiPath: String = "/databases/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/increment"
            .replacingOccurrences(of: "{databaseId}", with: databaseId)
            .replacingOccurrences(of: "{tableId}", with: tableId)
            .replacingOccurrences(of: "{rowId}", with: rowId)
            .replacingOccurrences(of: "{column}", with: column)
